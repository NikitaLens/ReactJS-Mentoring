...
class LoginPage extends Component {
    ...
    logIn(event) {
        ...
        this.props.onLogIn( { username: this.logUsername.value, password: this.logPassword.value } );
    ...
    signUp(event) {       
        event.preventDefault();
        this.props.onSignUp( { email: this.signEmail.value, fullname: this.signFullname.value, username: this.signUsername.value, password: this.signPassword.value } );
        this.logUsername.value = '';
        this.logPassword.value = '';
        this.signEmail.value = '';
        this.signFullname.value = '';
